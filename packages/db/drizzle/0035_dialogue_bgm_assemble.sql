...
-- 修改流水线阶段枚举，新增 dialogue / bgm / assemble（幂等：已存在则跳过）
DO $$ BEGIN
  ALTER TYPE "canvas_pipeline_phase" ADD VALUE 'dialogue' BEFORE 'videos';
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TYPE "canvas_pipeline_phase" ADD VALUE 'bgm' AFTER 'videos';
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TYPE "canvas_pipeline_phase" ADD VALUE 'assemble' AFTER 'bgm';
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
