...
export default function Login() {
  ...
  // 因此 banner 取 errors.email?.message。
  ...
  return (
    <AuthPageShell
      ...
      title="管理后台登录"
      description="仅授权管理员可访问。登录后可查看用户、任务、计费、Provider 与审计记录。"
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <p className="text-center text-xs text-muted-foreground">
          管理后台仅对授权账户开放；如需开通请联系系统管理员将你的用户 ID 加入
          {' '}
          <code className="font-mono">ADMIN_USER_IDS</code>
          。
        </p>
      </form>
    </AuthPageShell>
